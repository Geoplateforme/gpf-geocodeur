...
test('createInstance', t => {
  ...
  t.truthy(instance.featuresByIdxDb)
...
test('getFeatureByIdx', t => {
  ...
  instance.featuresByIdxDb.put(1, feature1)
  instance.featuresByIdxDb.put(2, feature2)
  instance.featuresByIdxDb.put(3, feature3)
...
test('getFeatureByIdx / no index', t => {
  ...
  instance.featuresByIdxDb.put(1, feature)
