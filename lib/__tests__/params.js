...
test('extractParam / city', t => {
  ...
  t.throws(
    () => extractCity('aa'),
    {message: 'must contain between 3 and 50 chars and start with a letter. numbers is not allowed'}
  )
  t.throws(
    () => extractCity('aa1'),
    {message: 'must contain between 3 and 50 chars and start with a letter. numbers is not allowed'}
...
test('extractParam / category', t => {
  ...
  t.is(extractCategory('foo'), 'foo')
  t.is(extractCategory(' foo '), 'foo')
  t.is(extractCategory(' foo-bar'), 'foo-bar')
  ...
  t.throws(
    () => extractCategory(Array.from({length: 60}).fill('a').join('')),
    {message: 'must contain between 3 and 50 chars and start with a letter. numbers is not allowed'}
  )
})
