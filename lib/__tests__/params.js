...
test('extratParam / citycode', t => {
  function extractCiycode(citycode) {
    return extractParam({citycode}, 'citycode', PARAMS.citycode)
  }

  t.is(extractCiycode('12345'), '12345')
  t.is(extractCiycode('1A345'), '1A345')
  t.is(extractCiycode('1B345'), '1B345')

  t.throws(() => extractCiycode('12A45'), {message: 'Param citycode is invalid'})
  t.throws(() => extractCiycode('A1245'), {message: 'Param citycode is invalid'})
  t.throws(() => extractCiycode('123A5'), {message: 'Param citycode is invalid'})
  t.throws(() => extractCiycode('1234A'), {message: 'Param citycode is invalid'})
  t.throws(() => extractCiycode('1a345'), {message: 'Param citycode is invalid'})
  t.throws(() => extractCiycode('1b345'), {message: 'Param citycode is invalid'})
  t.throws(() => extractCiycode('1A3456'), {message: 'Param citycode is invalid'})
})
...
test('extratParam / municipalitycode', t => {
  function extractCiycode(municipalitycode) {
    return extractParam({municipalitycode}, 'municipalitycode', PARAMS.municipalitycode)
  }

  t.is(extractCiycode('123'), '123')
  t.is(extractCiycode('001'), '001')
  t.is(extractCiycode('01'), '01')

  t.throws(() => extractCiycode('12A'), {message: 'Param municipalitycode is invalid'})
  t.throws(() => extractCiycode('A12'), {message: 'Param municipalitycode is invalid'})
  t.throws(() => extractCiycode('1A3'), {message: 'Param municipalitycode is invalid'})
})

test('extratParam / oldmunicipalitycode', t => {
  function extractCiycode(oldmunicipalitycode) {
  ...
  t.throws(() => extractCiycode('12A'), {message: 'Param oldmunicipalitycode is invalid'})
  t.throws(() => extractCiycode('A12'), {message: 'Param oldmunicipalitycode is invalid'})
  t.throws(() => extractCiycode('1A3'), {message: 'Param oldmunicipalitycode is invalid'})
})

test('extratParam / districtcode', t => {
  function extractCiycode(districtcode) {
    return extractParam({districtcode}, 'districtcode', PARAMS.districtcode)
  }

  t.is(extractCiycode('1234'), '1234')
  t.is(extractCiycode('1A34'), '1A34')
  t.is(extractCiycode('1B34'), '1B34')

  t.throws(() => extractCiycode('12A4'), {message: 'Param districtcode is invalid'})
  t.throws(() => extractCiycode('A124'), {message: 'Param districtcode is invalid'})
  t.throws(() => extractCiycode('123A'), {message: 'Param districtcode is invalid'})
  t.throws(() => extractCiycode('1a34'), {message: 'Param districtcode is invalid'})
  t.throws(() => extractCiycode('1b34'), {message: 'Param districtcode is invalid'})
  t.throws(() => extractCiycode('1A346'), {message: 'Param districtcode is invalid'})
})
