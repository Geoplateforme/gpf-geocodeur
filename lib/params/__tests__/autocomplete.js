...
test('validateLonlat', t => {
  ...
  t.throws(() => validateLonlat('foo,bar'), {message: 'Unable to parse value as float'})
})
...
test('extractParam / terr', t => {
  ...
  t.throws(() => extractTerr('foo,bar'), {message: 'Unexpected value \'foo\' for param terr'})
  t.throws(() => extractTerr('METROPOLE,bar'), {message: 'Unexpected value \'bar\' for param terr'})
})
...
test('extractParam / lonlat', t => {
  ...
  t.is(extractLonlat('1,-66'), '1,-66')
  t.is(extractLonlat('1.1,-66.56'), '1.1,-66.56')
...
test('extractParam / bbox', t => {
  ...
  t.is(extractBbox('1,-44,2,-66'), '1,-44,2,-66')
  t.is(extractBbox('1.1,-44.4,2.2,-66.56'), '1.1,-44.4,2.2,-66.56')
