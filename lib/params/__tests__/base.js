...
test('validateSearchgeom', t => {
  ...
  t.throws(() => validateSearchgeom({type: 'LineString', coordinates: [
    ...
    [2.3, 49.8],
    [2.3, 50.8]
  ]}), {message: 'Unable to parse value as float'})
})

test('validateSearchgeom / wrong structure', t => {
  t.throws(
    () => validateSearchgeom({type: 'Point', coordinates: [48.5]}),
    {message: 'Error: Parameter [searchgeom] Not valid Point geometry: coordinates must have 2 elements (lon, lat)'})
  ...
  t.throws(
    ...
    {message: 'Error: Parameter [searchgeom] Not valid LineString geometry: coordinates must be an array of points with at least 2 points'})
  ...
  t.throws(
    ...
    {message: 'Error: Parameter [searchgeom] Not valid Polygon geometry: coordinates must be an array of rings with at least 3 points in the outer ring'})
