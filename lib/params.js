...
function isDepartmentcodeValid(departmentcode) {
  if (departmentcode.length < 2 || departmentcode.length > 4 || departmentcode === '20') {
    return false
  }
  ...
  if ((departmentcode >= 1 && departmentcode <= 95) || departmentcode === '2A' || departmentcode === '2B') {
    return true
  }
